...
class InterstitialAd extends _MobileAd.MobileAd {
  ...
  static createForAdRequest(adUnitId, requestOptions) {
    ...
    return new InterstitialAd('interstitial', requestId, adUnitId, _NativeInterstitialModule.default.interstitialLoad.bind(this), _NativeInterstitialModule.default.interstitialShow.bind(this), options);
  }
