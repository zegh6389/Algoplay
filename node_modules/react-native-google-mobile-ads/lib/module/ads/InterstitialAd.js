...
export class InterstitialAd extends MobileAd {
  ...
  static createForAdRequest(adUnitId, requestOptions) {
    ...
    return new InterstitialAd('interstitial', requestId, adUnitId, NativeInterstitialModule.interstitialLoad.bind(this), NativeInterstitialModule.interstitialShow.bind(this), options);
  }
