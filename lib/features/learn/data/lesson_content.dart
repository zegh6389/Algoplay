...
// Source: /tmp/M2.txt
// ══════════════════════════════════════════════════════════════════════════════
// Lesson 7 — Module 2: Mergesort
// Order: 1 (second in lesson 7)
// ─────────────────────────────────────────────────────────────────────────────
//
      ...
      ModuleContent(
        ...
        contentBlocks: [
          ...
          TextBlock(
            'Mergesort sorts an array by: '
            '1. Dividing the array into two halves. '
            '2. Recursively sorting each half. '
            '3. Merging the two sorted halves into one sorted array.',
          ),
          TextBlock(
            'This matches the divide-and-conquer pattern: '
          ...
          TextBlock(
            ...
            'We conceptually "merge into" this new array.',
          ),
          ...
          TextBlock(
            'Once the subarrays are size 1, they are trivially sorted. '
            'Then we start merging back up. '
            'The cost we care about is the number of basic operations done by Merge.',
          ),

          // ── How Merge Works ──────────────────────────────────────────────
          TextBlock(
            'The Merge procedure combines two sorted subarrays into one sorted array.',
          ),
          TextBlock(
            'Typical approach: have one pointer i in the first subarray, '
            'another pointer j in the second subarray, '
            'and a pointer k into the new array.',
          ),
          TextBlock(
            'At each step: '
            '1. Compare the elements pointed to by i and j. '
            '2. Copy the smaller one into the new array at position k. '
            '3. Advance the pointer that you copied from and also advance k.',
          ),
          TextBlock(
            'If one of the two arrays runs out of elements, copy the remaining '
            'elements from the other array directly into the new array. '
          ...
          MathBlock(
            r'C_{\text{merge}}(n) = n - 1',
            semanticsLabel: 'worst case merge cost',
          ),

          // ── Recurrence ───────────────────────────────────────────────────
          TextBlock(
            'Let C(n) be the number of comparisons Mergesort does in the worst '
            'case when sorting an array of size n.',
          ),
          TextBlock(
          ...
          MathBlock(
            r'C(n) = 2\,C\!\left(\frac{n}{2}\right) + C_{\text{merge}}(n), \quad C(1) = 0',
          ...
          MathBlock(
            ...
            semanticsLabel: 'master theorem d calculation',
          ),
          TextBlock(
          ...
          MathBlock(
            ...
            semanticsLabel: 'Mergesort complexity',
          ),
          TextBlock(
          ...
          TextBlock(
            ...
            '5. How does Mergesort compare to Insertion Sort for large n?',
          ),

          // ── Mini Practice ────────────────────────────────────────────────
          TextBlock(
            'Practice 1: '
            'Write the recurrence for Mergesort if the merge step took 3n work '
            'instead of n work. What would the Master Theorem say about '
            'the complexity?',
          ),
          QuizBlock(
            question:
                'Write the recurrence for Mergesort if the merge step '
          ...
          QuizBlock(
            question:
                'For an array of size 8, draw the recursion tree of Mergesort, '
            ...
            correctIndex: 1,
            explanation:
                'A recursion tree for size 8 has log2(8) = 3 levels. '
                'Each level does Theta(n) total work (summing across all nodes). '
                'With log n levels, total is Theta(n log n). '
                'The number of nodes is n, but they are spread across log n levels.',
          ),
          QuizBlock(
            question:
                'Explain in your own words why Mergesort is considered '
                'a divide-and-conquer algorithm rather than decrease-and-conquer.',
            options: [
              'Because it reduces the problem to one smaller subproblem',
              'Because it splits into multiple subproblems and combines results',
              'Because it decreases the array size by one each step',
              'Because it uses a pivot element',
            ],
            correctIndex: 1,
            explanation:
                'Decrease and conquer reduces to one smaller subproblem at each step '
          ...
          // ── Final Thought ───────────────────────────────────────────────
          KeyTakeawayBlock(
            'Mergesort is the textbook example of how divide and conquer can '
            'turn a sorting problem into a clean recursive structure with '
            'Theta(n log n) performance. Its analysis also gives a concrete case '
            'where the Master Theorem applies directly and neatly.',
          ),
        ],
      ),
// ══════════════════════════════════════════════════════════════════════════════
// Module 3 — Counting Inversions
// Source: /tmp/m3.txt
// ══════════════════════════════════════════════════════════════════════════════
// Lesson 7 — Module 3: Counting Inversions
// Order: 2 (third in lesson 7)
// ─────────────────────────────────────────────────────────────────────────────
//
      ...
      ModuleContent(
        ...
        contentBlocks: [
          ...
          // ── Intro ─────────────────────────────────────────────────────────
          TextBlock(
            'In this module we introduce the problem of counting inversions '
            'and show how a divide-and-conquer strategy, similar to Mergesort, '
          ...
          MathBlock(
            ...
            semanticsLabel: 'array notation',
          ),
          DefinitionBlock(
            term: 'Inversion',
            definition:
                'A pair of indices (i, j) such that i < j and a sub i is greater '
                'than a sub j. Intuitively, an inversion is a pair that is '
                'out of order with respect to sorted ascending order.',
          ),
          TextBlock(
            'The number of inversions measures how far the array is from being sorted. '
            'For example, in the array [4, 2, 7, 1, 3, 5, 8, 6], '
            'pairs such as (4, 2), (4, 1), and (7, 1) are inversions.',
          ),

          // ── Brute Force ───────────────────────────────────────────────────
          TextBlock(
            'A straightforward algorithm to count inversions: '
            'look at every pair of positions (i, j) with i < j, '
            'check whether a sub i is greater than a sub j, '
            'increment a counter when we find an inversion.',
          ),
          TextBlock(
            'There are n choose 2 such pairs, and so this algorithm runs in '
            'time proportional to n squared. '
            'We would like something faster.',
          ),
          MathBlock(
            r'\Theta(n^2)',
            semanticsLabel: 'brute force inversion counting complexity',
          ),

          // ── Divide and Conquer Strategy ───────────────────────────────────
          TextBlock(
            'We adapt the idea of Mergesort to count inversions more efficiently. '
            'Recall Mergesort: divides the array into two halves, '
            'recursively sorts each half, merges the two sorted halves.',
          ),
          TextBlock(
            'We do something similar, but also keep track of how many inversions we see.',
          ),
          TextBlock(
            'High-level steps: '
          ...
          // ── Counting Between-Half Inversions While Merging ───────────────
          TextBlock(
            'We use a modified Merge procedure that works like Mergesort '
          ...
          TextBlock(
            'The key insight (from Kleinberg and Tardos): '
            'when we copy an element from right subarray B before one or more '
            'remaining elements in left subarray A, '
            'then each of those remaining elements in A forms an inversion '
            'with that element from B.',
          ),
          TextBlock(
            'Implementation idea: every time we place an element from the right '
            'half into the new array before the remaining elements in the left '
            'half, we increase the inversion count by the number of elements '
            'still left in the left half.',
          ),
          TextBlock(
            'Consider the array [4, 2, 7, 1, 3, 5, 8, 6]. '
            'At various merge steps, we count how many elements in the left half '
            'are greater than the next element in the right half and add that '
            'to the inversion total.',
          ),

          // ── Recurrence and Complexity ─────────────────────────────────────
          TextBlock(
            'Let D(n) be the time to count inversions in an array of size n '
            'using this method.',
          ),
          TextBlock(
          ...
          MathBlock(
            r'D(n) = 2D\!\left(\frac{n}{2}\right) + C_{\text{merge}}(n)',
          ...
          MathBlock(
            ...
            semanticsLabel: 'inversions recurrence simplified',
          ),
          TextBlock(
          ...
          MathBlock(
            ...
            semanticsLabel: 'inversions complexity',
          ),
          TextBlock(
            'So counting inversions can be done in Theta(n log n) time, '
            'much faster than the naive Theta(n squared) algorithm.',
          ),
          ...
          TextBlock(
            ...
            'cross inversions efficiently during a single linear-time merge.',
          ),
          TextBlock(
          ...
          KeyTakeawayBlock(
            ...
            'This transforms a quadratic problem into a near-linearithmic one.',
          ),

          // ── Stop and Think ───────────────────────────────────────────────
          TextBlock(
            'Stop and Think: '
            '1. Why does the simple double-loop approach take Theta(n squared) time? '
            '2. Why can all cross inversions be found during the merge step? '
            '3. How does the modified Merge know how many inversions to add '
            'when it takes an element from the right half? '
            '4. Why does the recurrence have the same form as Mergesort? '
            '5. What kinds of problems benefit from the sort-plus-extra-information pattern?',
          ),

          // ── Mini Practice ────────────────────────────────────────────────
          QuizBlock(
            question:
                'Manually count the inversions in the array [3, 1, 2] '
                'using the brute force method. '
                'How does the divide-and-conquer method discover the same count?',
            options: [
              '[3,1] and [3,2] are inversions, total 2',
              '[3,1] only, total 1',
              '[1,2] only, total 1',
            ...
            correctIndex: 0,
            explanation:
                '[3,1] is an inversion because 3 > 1 and 3 comes before 1. '
                '[3,2] is an inversion because 3 > 2 and 3 comes before 2. '
                '[1,2] is not an inversion because 1 < 2. '
                'Total: 2 inversions. '
                'The divide-and-conquer method discovers these during the merge step.',
          ),
          QuizBlock(
            question:
                'Why does the recurrence for counting inversions have '
                'the same form as Mergesort?',
            options: [
              'Because both sort the array',
              'Because both split into two halves and do linear merge work',
              'Because both are quadratic algorithms',
              'Because counting inversions is the same as sorting',
            ],
            correctIndex: 1,
            explanation:
                'Both algorithms split the array in half, recursively solve each half, '
                'then perform a linear-time merge. '
                'The only difference is that counting inversions adds counting work '
                'during the merge, which is still O(n).',
          ),
          QuizBlock(
            question:
            ...
            correctIndex: 0,
            explanation:
                'A sorted array has zero inversions because no element is greater '
                'than an element that comes after it. '
                'In the divide-and-conquer algorithm, the merge step will always '
                'take from the left half first, never adding to the inversion count.',
          ),

          // ── Final Thought ───────────────────────────────────────────────
          KeyTakeawayBlock(
            'Counting inversions is a powerful example of how divide and conquer '
            'can transform a seemingly quadratic problem into a Theta(n log n) one. '
            'By reusing the structure of Mergesort and adding a small twist '
            'during merge, we obtain both a sorted array and a meaningful measure '
            'of how unsorted the original array was.',
          ),
        ],
      ),
// ══════════════════════════════════════════════════════════════════════════════
// Module 4 — Quicksort  (source: /tmp/M4.txt — titled "Module 5: Quicksort")
// ══════════════════════════════════════════════════════════════════════════════
// Lesson 7 — Module 5: Quicksort
// Order: 3 (fourth in lesson 7)
// ─────────────────────────────────────────────────────────────────────────────
//
      ...
      ModuleContent(
        ...
        contentBlocks: [
          ...
          TextBlock(
            'This is different from Mergesort, where combining (merging) is the '
            'main extra work. In Quicksort, the hard work is in the '
            'partitioning step.',
          ),

          // ── Partition ─────────────────────────────────────────────────────
          TextBlock(
            'Assume we have already seen Quicksort in previous courses. '
          ...
          TextBlock(
            'One way to picture partitioning: '
            'Start from one end of the array and move through the elements. '
            'Swap elements so that smaller ones move toward the left region '
            'and larger ones toward the right region.',
          ),
          TextBlock(
            'After partitioning: '
          ...
          // ── Worst-Case Analysis ───────────────────────────────────────────
          TextBlock(
            'Basic operation: comparison of two keys.',
          ),
          TextBlock(
          ...
          MathBlock(
            ...
            semanticsLabel: 'quicksort worst case sum',
          ),
          TextBlock(
          ...
          TextBlock(
            'So Quicksort has quadratic time in the worst case, '
            'the same order as simple algorithms like Insertion Sort.',
          ),

          // ── Average-Case Idea ─────────────────────────────────────────────
          TextBlock(
            'In practice, Quicksort is usually fast because the pivot is '
            'rarely always the smallest or largest element.',
          ),
          TextBlock(
            'To analyze the average case, we make assumptions such as: '
            'all permutations of the keys are equally likely, '
            'all keys are distinct, '
            'the pivot position is equally likely to be any of the positions '
            'in the array.',
          ),
          TextBlock(
            'Let A(n) be the average number of basic operations (comparisons) '
            'used by Quicksort on an array of size n.',
          ),
          TextBlock(
            'A more detailed analysis leads to a recurrence of the form:',
          ),
          MathBlock(
            r'A(n) = (n+1) + \sum_{i=0}^{n-1} \frac{1}{n} \big(A(i) + A(n-1-i)\big), \quad A(1) = A(0) = 0',
            semanticsLabel: 'quicksort average case recurrence',
          ),
          TextBlock(
            'Each term A(i) actually appears twice in the sum (once as a left '
            'subarray, once as a right subarray), so the recurrence can also '
            'be written as: A(n) = n + 1 + (2/n) times the sum from i=1 to n-1 of A(i).',
          ),
          MathBlock(
            r'A(n) = n + 1 + \frac{2}{n} \sum_{i=1}^{n-1} A(i)',
            semanticsLabel: 'quicksort average case simplified',
          ),
          TextBlock(
            'This recurrence is hard to solve directly. One common approach '
            'is to guess a simpler comparison function Q(n) that behaves like '
            'the solution, then prove by induction that the guess works.',
          ),
          TextBlock(
          ...
          TextBlock(
            ...
            'and f(n) in Theta(n)), this implies:',
          ),
          MathBlock(
            r'Q(n) \in \Theta(n \log n)',
            semanticsLabel: 'quicksort average case result',
          ),
          TextBlock(
            'Under reasonable assumptions, and with more careful analysis, '
            'the actual average-case behaviour of Quicksort matches this '
            'order of growth: A(n) in Theta(n log n) for the average case.',
          ),

          // ── Summary ──────────────────────────────────────────────────────
          KeyTakeawayBlock(
            'Quicksort summary: '
            'Paradigm: divide and conquer with focus on partitioning. '
            'Basic operation: comparison. '
            'Worst-case time: Theta(n squared). '
            'Average-case time: Theta(n log n). '
            'In-place and usually fast in practice, especially with good pivot choices. '
            'Great example of an algorithm whose worst case is poor but whose '
          ...
          TextBlock(
            'Stop and Think: '
            '1. Why does Quicksort have no heavy combine step compared to Mergesort? '
          ...
          QuizBlock(
            ...
            correctIndex: 1,
            explanation:
                'When the array is already sorted and the first element is '
                'chosen as pivot, every partition puts the pivot at the start '
                'of the remaining subarray, leaving one side empty. '
                'This causes O(n) partitions of sizes n, n-1, n-2, ..., 2, '
                'giving Theta(n squared) worst-case time.',
          ),
          QuizBlock(
            question:
          ...
          QuizBlock(
            question:
                'Compare Quicksort and Mergesort in terms of worst case, '
            ...
            correctIndex: 1,
            explanation:
                'Quicksort: worst-case O(n squared) when pivot is always extremal, '
                'average-case O(n log n), in-place (no extra array needed). '
                'Mergesort: always O(n log n), but requires an auxiliary array '
                'of size n for merging. In practice, Quicksort is often faster '
                'due to better cache behaviour and smaller constant factors.',
          ),

          // ── Final Thought ───────────────────────────────────────────────
          KeyTakeawayBlock(
            'Quicksort ties together many ideas in this lesson: '
            'divide-and-conquer structure, detailed recurrence analysis, '
            'and the difference between worst-case and average-case efficiency. '
            'It remains one of the most widely used sorting algorithms in '
            'real systems today.',
          ),
        ],
      ),
// ══════════════════════════════════════════════════════════════════════════════
// Module 5 — Multiplication of Large Integers
// Source: /tmp/M5.txt
// ══════════════════════════════════════════════════════════════════════════════
// Lesson 7 — Module 6: Multiplication of Large Integers
// Order: 4 (fifth in lesson 7)
// ─────────────────────────────────────────────────────────────────────────────
//
      ...
      ModuleContent(
        ...
        contentBlocks: [
          ...
          // ── Motivation ───────────────────────────────────────────────────
          TextBlock(
            'In this module we see how divide and conquer can speed up '
            'the multiplication of large integers. '
            'This is closely related to ideas used in cryptography, '
            'where very large numbers must be multiplied efficiently.',
          ),
          TextBlock(
          ...
          TextBlock(
            ...
            'on numbers of about half the size, and do this recursively, '
            'we get a divide-and-conquer algorithm.',
          ),
          ...
          MathBlock(
            r'M(n) = 3^{\log_2 n}',
            semanticsLabel: 'multiplication complexity before rewriting',
          ),
          TextBlock(
          ...
          MathBlock(
            r'M(n) = n^{\log_2 3}',
            semanticsLabel: 'large integer multiplication final complexity',
          ),
          TextBlock(
          ...
          TextBlock(
            'Stop and Think: '
            '1. Why does reducing from 4 to 3 multiplications for the half-size '
            ...
            'be generalized when it is not?',
          ),

          // ── Mini Practice ────────────────────────────────────────────────
          QuizBlock(
            question:
                'Work through the 45 times 28 example completely using '
                'the three-multiplication trick. Verify that the final product is correct.',
            options: [
              'The result is 1160 using 3 multiplications',
              'The result is 1260 using 3 multiplications',
              'The result is 1260 using 4 multiplications',
              'The three-multiplication trick does not work for this example',
            ],
            correctIndex: 1,
            explanation:
          ...
          QuizBlock(
            question:
                'Starting from M(2 to the power of k) = 3 to the power of k, '
                'show step by step how to reach M(n) = n to the power of log base 2 of 3.',
            options: [
              'Use the identity a to the power of log base b of c = c to the power of log base b of a',
              'Substitute n = 2k directly',
              'Divide both sides by log n',
              'The conversion is not possible without a calculator',
            ],
            correctIndex: 0,
            explanation:
                'Since M(2 to the power of k) = 3 to the power of k, '
                'and n = 2 to the power of k, we have M(n) = 3 to the power of log base 2 of n. '
                'Using the identity a to the power of log base b of c = c to the power of log base b of a, '
                '3 to the power of log base 2 of n = n to the power of log base 2 of 3.',
          ),
          QuizBlock(
            question:
                'Compare the orders of growth n squared and n to the power of 1.585 '
                'for very large n. Which grows faster?',
            options: [
              'n squared grows faster',
              'n to the power of 1.585 grows faster',
              'They grow at the same rate',
              'Depends on the constant factors only',
            ],
            correctIndex: 0,
            explanation:
                'Since 2 > 1.585, n squared has a higher exponent in the asymptotic sense. '
                'For sufficiently large n, n squared dominates n to the power of 1.585, '
                'meaning the divide-and-conquer algorithm is strictly faster '
                'asymptotically than the grade-school Theta(n squared) method.',
          ),

          // ── Final Thought ───────────────────────────────────────────────
          KeyTakeawayBlock(
            'Multiplication of large integers via divide and conquer is a beautiful '
            'example of how algebraic insight and recursion can work together '
            'to beat the obvious algorithm. It also connects directly to practical '
            'problems in cryptography, where such speedups really matter.',
          ),
        ],
      ),
// ══════════════════════════════════════════════════════════════════════════════
// Module 6 — Multiplication of Matrices (Strassen)
// Source: /tmp/M6.txt
// ══════════════════════════════════════════════════════════════════════════════
// Lesson 7 — Module 4: Multiplication of Matrices (Strassen)
// Order: 5 (sixth in lesson 7)
// ─────────────────────────────────────────────────────────────────────────────
//
      ...
      ModuleContent(
        ...
        contentBlocks: [
          ...
          // ── From Integer Multiplication to Matrices ──────────────────────
          TextBlock(
            'In this module we see how divide and conquer can speed up '
            'matrix multiplication. The focus is on Strassen algorithm, '
            'which shows that multiplying large matrices can be done faster '
            'than the classical Theta(n cubed) approach.',
          ),
          TextBlock(
            'Earlier, we saw that divide and conquer can help with '
          ...
          // ── Classical 2x2 Matrix Multiplication ──────────────────────────
          TextBlock(
            'Consider multiplying two 2 times 2 matrices: C = A times B.',
          ),
          MathBlock(
            r'C = A B',
            semanticsLabel: 'matrix product',
          ),
          TextBlock(
            'The usual formula for C requires 8 scalar multiplications '
            'and 4 additions.',
          ),
          MathBlock(
            r'c_{00} = a_{00}b_{00} + a_{01}b_{10},\quad '
            r'c_{01} = a_{00}b_{01} + a_{01}b_{11},\quad '
            r'c_{10} = a_{10}b_{00} + a_{11}b_{10},\quad '
            r'c_{11} = a_{10}b_{01} + a_{11}b_{11}',
            semanticsLabel: '2x2 matrix multiplication formula',
          ),
          TextBlock(
            'Strassen observed that by cleverly rearranging the computations, '
            'we can get the same result using 7 multiplications instead of 8, '
            'at the cost of doing more additions and subtractions.',
          ),

          // ── Strassen's 2x2 Construction ──────────────────────────────────
          TextBlock(
            'Strassen defines 7 intermediate products m sub 1 through m sub 7 '
            'as certain combinations of entries from A and B.',
          ),
          TextBlock(
            'Using matrix notation, the product matrix C can be written in '
            'terms of these m sub i values so that all entries of C are '
            'obtained using only 7 scalar multiplications.',
          ),
          TextBlock(
            'You are not required to memorize the exact formulas, but you '
            'should understand the idea: '
            'first compute 7 carefully chosen products, '
            'then combine them with additions and subtractions to get each c sub ij. '
            'The key takeaway: the structure of 2 times 2 matrix multiplication '
            'allows one multiplication to be saved.',
          ),

          // ── Extending to Larger Matrices ────────────────────────────────
          TextBlock(
            'To apply Strassen idea to larger matrices, suppose A and B are '
          ...
          MathBlock(
            ...
            r' B = \begin{bmatrix} B_{00} & B_{01} \\ B_{10} & B_{11} \end{bmatrix}',
            semanticsLabel: 'matrix block partitioning',
          ),
          TextBlock(
          ...
          // ── Recurrence for Multiplications ──────────────────────────────
          TextBlock(
            'Let M(n) be the number of scalar multiplications needed to '
          ...
          MathBlock(
            ...
            semanticsLabel: 'Strassen complexity before approximation',
          ),
          TextBlock(
          ...
          // ── Counting Additions ──────────────────────────────────────────
          TextBlock(
            'Strassen method reduces the number of multiplications, '
            'but increases the number of additions and subtractions.',
          ),
          TextBlock(
          ...
          QuizBlock(
            question:
                'Compare the leading term of the classical n cubed algorithm '
                'to n to the power of 2.807 for a large n. '
                'How big is the difference in order-of-magnitude terms?',
            options: [
              'n cubed is faster because 3 > 2.807',
              'n to the power of 2.807 is faster because the exponent is smaller',
              'They are the same order of growth',
              'n cubed is faster only for very small n',
            ],
            correctIndex: 1,
            explanation:
                'Since 2.807 < 3, n to the power of 2.807 grows more slowly '
                'as n increases. For large n, n to the power of 2.807 is '
                'asymptotically strictly better than n cubed, even though '
                'both are polynomial. The difference is meaningful in practice '
                'for large-scale matrix computations.',
          ),
          QuizBlock(
            question:
                'Explain why the additions recurrence '
                'A(n) = 7A(n over 2) + 18(n over 2) squared '
            ...
            options: [
              ...
              'Because the recurrence matches the Master Theorem form with a=7, b=2, '
                'and the non-recursive term is O(n to the power of 2)',
              'Because matrix addition is always slower than multiplication',
              'Because the additions recurrence is identical to the multiplication recurrence',
            ],
            correctIndex: 1,
            explanation:
                'Here a = 7, b = 2, so d = log base 2 of 7 approximately 2.807. '
                'The nonrecursive term 18(n over 2) squared = 18 times n squared over 4 = 4.5 n squared, '
                ...
                'So the solution is Theta(n to the power of d) = '
                'Theta(n to the power of log base 2 of 7).',
          ),

          // ── Final Thought ───────────────────────────────────────────────
          KeyTakeawayBlock(
            'Strassen algorithm shows that even a small saving at the base '
            '2 times 2 level can have a dramatic effect when applied recursively. '
            'It is an important example of how creative algebraic manipulation, '
            'combined with divide and conquer, can lead to asymptotically '
            'faster algorithms.',
          ),
        ],
      ),
// ══════════════════════════════════════════════════════════════════════════════
// Module 7 — Conclusion  (source: /tmp/M8.txt — "Lesson 7: Conclusion")
// ══════════════════════════════════════════════════════════════════════════════
// Lesson 7 — Module 7: Conclusion
// Order: 6 (seventh in lesson 7)
// ─────────────────────────────────────────────────────────────────────────────
//
      ...
      ModuleContent(
        ...
        contentBlocks: [
          ...
          // ── Intro ─────────────────────────────────────────────────────────
          TextBlock(
            'In Lesson 7, we explored the concept of Divide and Conquer '
            'and saw numerous examples of how these algorithms are modeled '
            'using recurrence relations.',
          ),

          // ── Why "2" Appears So Often ────────────────────────────────────
          TextBlock(
          ...
          TextBlock(
            'Counting Inversions: How a small modification to Mergesort '
            'allows us to count out-of-order pairs efficiently.',
          ),
          TextBlock(
            ...
            'O(n cubed) to approximately O(n to the power of 2.807).',
          ),
          ...
          TextBlock(
            'Instead of making the problem smaller directly (like in '
            'Decrease and Conquer or Divide and Conquer), this approach '
            'takes a problem out of the domain in which it was originally '
            'defined and transforms it into a new region.',
          ),
          TextBlock(
          ...
          TextBlock(
            'It is a very different way of thinking about problem-solving, '
            'and it introduces some fun new tools and structures along the way!',
          ),
        ],
      ),
    ],
